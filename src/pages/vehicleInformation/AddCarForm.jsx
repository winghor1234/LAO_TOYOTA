        ...
        <form onSubmit={handleSubmit} className='flex flex-col md:items-center lg:flex-row justify-center lg:justify-around gap-6 lg:gap-4'>
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className='flex flex-col gap-2 my-3 w-full max-w-[250px]'>
              <button onClick={() => { SuccessAlert("ຍົກເລີກການເພີ່ມຂໍ້ມູນລົດສຳເລັດ"); onClose(); }} className='w-full py-2 border cursor-pointer border-gray-300 rounded-lg text-sm hover:bg-gray-100 transition-colors'>
                ຍົກເລີກການເພີ່ມ
              </button>
              <button type='submit' onClick={() => { SuccessAlert("ເພີ່ມຂໍ້ມູນລົດສຳເລັດ"); onClose(); }} className='w-full py-2 border cursor-pointer border-red-500 rounded-lg text-sm bg-red-500 text-white hover:bg-[#E32121] transition-colors'>
                ເພີ່ມລົດ
              </button>
            </div>
          </div>
...
export default AddCarFormPopup;

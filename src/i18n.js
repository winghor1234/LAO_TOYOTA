...
i18n.use(initReactI18next).init({
    resources: {
        en: { auth: authEn, booking: bookingEn, car: carEn, dashboard: dashboardEn, gift: giftEn, promotion: promotionEn, report: reportEn, service: serviceEn, timeZone: timeZoneEn, user: userEn, headerSidebar: headerSidebarEn, util: utilEn},
        lo: { auth: authLo, booking: bookingLo, car: carLo, dashboard: dashboardLo, gift: giftLo, promotion: promotionLo, report: reportLo, service: serviceLo, timeZone: timeZoneLo, user: userLo, headerSidebar: headerSidebarLo, util: utilLo},
    },
    lng: savedLang, // default จาก localStorage
    fallbackLng: "lo",
    ns: ["auth", "booking", "car","dashboard", "gift", "promotion", "report", "service", "timeZone","user","headerSidebar","util"], // ระบุ namespace
